...
from xau_lab.experiments.edge_b_sampler import EDGE_B_DEFAULT_SEED
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Run or resume the isolated Edge B trend/pullback research campaign"
    )
    parser.add_argument(
        "--catalog",
        type=Path,
    ...
    parser.add_argument("--result-root", type=Path, default=Path("edge_b/results"))
...
def main() -> None:
    ...
    print("Edge B campaign run completed or resumed successfully")
