...
ACTIVATION_MIN_50_COUNT = 205
ACTIVATION_MIN_300_COUNT = 64
...
class ActivationDecision:
    ...
    def to_dict(self) -> dict[str, object]:
        return {
            ...
            "thresholds": {
                "min_configs_with_50_trades": ACTIVATION_MIN_50_COUNT,
                "min_configs_with_300_trades": ACTIVATION_MIN_300_COUNT,
                "max_end_of_data_fraction": ACTIVATION_MAX_END_OF_DATA_FRACTION,
                "require_total_completed_trades_gt_zero": True,
            },
            "zero_trade_count": self.zero_trade_count,
            "zero_trade_fraction": (
                self.zero_trade_count / self.sample_size if self.sample_size else None
            ),
            "at_least_50_count": self.at_least_50_count,
            "at_least_50_fraction": (
                self.at_least_50_count / self.sample_size if self.sample_size else None
            ),
...
def evaluate_activation(
    ...
    at_least_50 = int(np.count_nonzero(completed_array >= 50))
    ...
    if at_least_50 < ACTIVATION_MIN_50_COUNT:
        reasons.append("configs_with_50_trades_below_205")
    if at_least_300 < ACTIVATION_MIN_300_COUNT:
        reasons.append("configs_with_300_trades_below_64")
